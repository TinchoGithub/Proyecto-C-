...
namespace GestionTelefoniaCable
{
    ...
    public class LotePrueba
    {
        ...
        public LotePrueba()
        {
            ...
            Periodo marzo = new Periodo (new DateTime(2022, 03, 6), new DateTime(2022, 04, 5));

            Periodo abril = new Periodo (new DateTime(2022, 04, 6), new DateTime(2022, 05, 5));
            
            Periodo mayo = new Periodo (new DateTime(2022, 05, 6), new DateTime(2022, 06, 5));
            
            Periodo junio = new Periodo (new DateTime(2022, 06, 6), new DateTime(2022, 07, 5));
            
            Periodo julio = new Periodo (new DateTime(2022, 07, 6), new DateTime(2022, 08, 5));
            
            Periodo agosto = new Periodo (new DateTime(2022, 08, 6), new DateTime(2022, 09, 5));
            ...
            //cliente1.agregarFactura(new Factura(5, julioPeriodo));
            ...
            //cliente2.agregarFactura(new Factura(5, julioPeriodo));
            ...
            //cliente3.agregarFactura(new Factura(4, julioPeriodo));
            ...
            //cliente4.agregarFactura(new Factura(2, julioPeriodo));
			...
			//cliente5.agregarFactura(new Factura(3, julioPeriodo));
